...
const OrderTracking = () => {
  ...
  // live liveLocation update every 10 setSearchParams
  useEffect(() => {
        ...
        <div className="grid lg:grid-cols-3 gap-6">
              ...
              order.status !== 'Cancelled' && (
                <div className="bg-white rounded-2xl p-5 flex items-center justify-between">
                  ...
                  <a
                    ...
                    className="p-2.5 bg-app-cream rounded-xl hover:bg-app-cream-dark
                  transition-colors"
                  >
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5">
              ...
              <p className="tex-sm text-app-text-light leading-relaxed">
            ...
            <div className="mt-4 pt-3 text-sm border-t border-app-border space-y-1.5">
              ...
              <div
                className="flex justify-between pt-2 border-t border-app-border 
