...
// Mappa locale dei colori per lo stato dell'ordine (evita crash da import esterni mancanti)
const statusColors: Record<string, string> = {
  Placed: 'bg-blue-50 text-blue-600 border border-blue-200',
  'Out of delivery': 'bg-orange-50 text-orange-600 border border-orange-200',
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-sm text-app-text-light mb-4">
              Compra ora per vedere i tuoi ordini qui..
            </p>
            <Link
              to={'/products'}
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <p className="text-sm font-medium text-app-green">
                      Order #
                      {order.id ? order.id.slice(-8).toUpperCase() : '__'}
                    </p>
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  {(order.items || []).length > 4 && (
                    <div
                      className="size-12 sm:size-16 rounded-lg bg-app-cream 
                ...
                {/* total items & price */}
                <div className="flex justify-between items-center pt-3 text-sm border-t border-zinc-100">
