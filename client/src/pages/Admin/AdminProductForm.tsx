  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Controlla la struttra della risposta del backend
        ...
        console.error(
          'Errore durante il caricamento del prodotto dal DB:',
          error,
        );
        toast.error(
          error.response?.data?.message || 'Impossibile caricare il prodotto',
        );
      } finally {
        setLoading(false);
      }
  ...
  const handleSubmit = async (e: React.SubmitEvent) => {
    ...
    try {
      ...
      if (imageFile) {
        ...
        finalImageUrl = data.url || data.imageUrl || data.path;
      }
      if (!finalImageUrl) {
