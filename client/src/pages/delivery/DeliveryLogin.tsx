...
export default function DeliveryLogin() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Salviamo l'oggetto partner in delivery_partner e la stringa token in delivery_token
                ...
                <div className="w-full max-w-md">
                    <div className="text-center mb-8">
                        <div className="flex-center gap-2 mb-4">
                            ...
                            <span className="text-2xl font-semibold text-app-green">🎯 Super Mercato</span>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 space-y-5">
                        ...
                        <div>
                            ...
                            <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} className="w-full px-4 py-2.5 rounded-xl border
                             not-focus:border-app-border text-sm transition-colors" placeholder="••••••••" />
                        </div>
                        <button type="submit" disabled={loading} className="w-full py-3 bg-app-green
